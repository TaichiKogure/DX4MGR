...
def simulate_standard_flow_v9_1(
    days=365,
    arrival_rate=0.5,
    ...
    **kwargs
    ...
    """
    Ver9.1 標準フロー版（SMALL_EXP→PROTO→BUNDLE→DR_GATE）
...
def _single_trial(args):
    params, seed = args
    return simulate_standard_flow_v9_1(**params, seed=seed)

def run_monte_carlo_v9_1(n_trials=100, use_parallel=True, **params):
    """
    モンテカルロ（標準フロー版）
